...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      bool enr = _enrolled[msg.sender];
      require(enr == true, "Only enrolled are allowed to deposit");
    ...
    function enrolled(address addr) public view returns (bool){
      return _enrolled[addr];
    }
}
